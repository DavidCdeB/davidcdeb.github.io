...
function update(){
 ...
 if(document.getElementById("as1").checked){ str=str+"vibration scale 3.0;" }
 if(document.getElementById("as2").checked){ str=str+"vibration scale 6.0;" }
 if(document.getElementById("as3").checked){ str=str+"vibration scale 12.0;" }
 ...
 if(document.getElementById("vs1").checked){ str=str+"vector scale 10.0;" }
 if(document.getElementById("vs2").checked){ str=str+"vector scale 25.0;" }
 if(document.getElementById("vs3").checked){ str=str+"vector scale 50.0;" }
